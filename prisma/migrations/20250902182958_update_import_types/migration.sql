/*
  ...
  - The values [stock_issue,warehouse_transfer] on the enum `ImportHistory_importType` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE `importhistory` MODIFY `importType` ENUM('full', 'stock_receive', 'stock_transfer', 'stock_alert', 'adjustment') NOT NULL;
