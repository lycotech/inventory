/*
  ...
  - You are about to alter the column `quantityReceived` on the `batch` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Decimal(15,4)`.
  - You are about to alter the column `quantityRemaining` on the `batch` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Decimal(15,4)`.
  - You are about to alter the column `quantity` on the `batchtransaction` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Decimal(15,4)`.
  - You are about to alter the column `stockQty` on the `inventory` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Decimal(15,4)`.
  - You are about to alter the column `quantity` on the `stocktransaction` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Decimal(15,4)`.
...
-- AlterTable
ALTER TABLE `batch` MODIFY `quantityReceived` DECIMAL(15, 4) NOT NULL,
    MODIFY `quantityRemaining` DECIMAL(15, 4) NOT NULL;

-- AlterTable
ALTER TABLE `batchtransaction` MODIFY `quantity` DECIMAL(15, 4) NOT NULL;

-- AlterTable
ALTER TABLE `inventory` MODIFY `stockQty` DECIMAL(15, 4) NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE `stocktransaction` MODIFY `quantity` DECIMAL(15, 4) NOT NULL;
